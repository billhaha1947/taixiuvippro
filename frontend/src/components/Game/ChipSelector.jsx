// ============================================
// components/Game/ChipSelector.jsx - Chọn Chip
// ============================================
  ...
  return (
    <button
      ...
      className={`
        ...
        ${selected ? 'scale-110 shadow-2xl ring-4 ring-dragon-gold' : 'hover:scale-105'}
    ...
    >
      ...
      {/* Value */}
      <span className="text-white font-display font-bold text-sm md:text-lg drop-shadow-lg z-10">
        {label}
      </span>
...
const ChipSelector = ({ selectedAmount, onSelectAmount }) => {
  return (
    <div className="bg-gradient-to-r from-casino-black via-casino-dark to-casino-black border-2 border-dragon-red/30 rounded-2xl p-6 shadow-neon-red">
      <h3 className="text-dragon-gold font-display font-bold text-center mb-4 text-lg">
        CHỌN MỨC CƯỢC
      </h3>
      ...
      {selectedAmount > 0 && (
        <div className="mt-4 text-center">
          ...
          <p className="text-dragon-gold font-display font-bold text-2xl">
