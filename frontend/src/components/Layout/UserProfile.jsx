...
const UserProfile = ({ user }) => {
  ...
  return (
    <div className="absolute top-20 left-4 bg-gradient-to-br from-casino-dark to-casino-black border-2 border-dragon-red/30 rounded-xl shadow-neon-red p-4 z-10">
